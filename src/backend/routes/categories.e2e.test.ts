...
import { CategoryService } from "../classes/category";
...
describe(`API returns category list`, () => {
  ...
  test(`Category names are "Музыка", "Программирование", "Железо", "IT"`,
      () => expect(response.body).toEqual(
          expect.arrayContaining([`Музыка`, `Программирование`, `Железо`, `IT`])
      )
  );
});
